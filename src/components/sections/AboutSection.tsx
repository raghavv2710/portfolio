...
const AboutSection = () => {
  return (
    <SectionWrapper id="about" className="pt-8 pb-12">
      ...
      <div className="grid md:grid-cols-3 gap-8">
        {aboutData.map((item, index) => (
          <Card key={index} className="backdrop-blur-sm transform transition-all duration-300 hover:scale-105 hover:border-primary">
