  ...
  return (
    <SectionWrapper id="ai-analysis" className="py-12 md:py-16">
      ...
      <div className="w-full max-w-2xl mx-auto flex flex-col gap-12">
        <Card className="bg-card/50 backdrop-blur-sm border-2 dark:border-primary/30">
          <CardHeader>
        ...
        <Card className="bg-card/50 backdrop-blur-sm border-2 dark:border-primary/30 flex flex-col items-center justify-center min-h-[400px]">
          {isLoading && (
